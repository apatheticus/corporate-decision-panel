...
1. **Write your findings file** to `{session}/findings/vp-delivery/qa-delivery-standards-lead.md` using the Write tool. The file content is your complete output (using your output template above). This file serves as a durable completion signal.
