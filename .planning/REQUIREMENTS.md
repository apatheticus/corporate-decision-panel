...
- [x] **CAO-01**: Legal/Contracts Lead removed from CAO team lead roster (agent file deleted)
- [x] **CAO-02**: CAO agent definition updated — no Legal/Contracts references, legal routes to CLO note added
- [x] **CAO-03**: All references to CAO Legal/Contracts Lead across codebase swept and updated (22 files identified in research)
- [x] **CAO-04**: VP Sales Business Development Lead cross-domain challenge re-wired from CAO Legal/Contracts to CLO Contracts & Commercial
...
- [x] **MODE-02**: CLO weighting added to all 5 decision mode sections in agents/ceo.md (skeptic group updates)
