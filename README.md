...
![Corporate Decision Panel](docs/media/board-in-a-box.png)
...
![From prompting to orchestrating](docs/media/human-orc.png)
...
![Engagement Tiers](docs/media/engage-tiers.png)
...
![Decision Modes](docs/media/synth-modes.png)
...
![Engineered Dissent](docs/media/eng-dissent.png)
...
![Beyond the Swarm](docs/media/beyond-swarm.png)
...
![The Depth Gap](docs/media/depth-gap.png)
...
![Tier 1 and Tier 2](docs/media/tiers-1-2.png)
...
![Team Leads](docs/media/team-leads.png)
...
![Operational Isolation](docs/media/isolation.png)
...
![Full Cascade](docs/media/tier-3.png)
...
![Distributed Architecture](docs/media/orc-intel.png)
...
![Production Pipeline](docs/media/production.png)
...
![GitHub Repository](docs/media/gh.png)
